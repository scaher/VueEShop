  ...
  <div>
    ...
    >
      ...
      <el-form
        ...
        label-width="100px"
      >
        <el-form-item label="分类名称：" prop="validate">
...
export default {
  ...
  computed:{
      yushu(){
          return (this.total%this.queryInfo.pagesize === 0)
      }
  },
  methods: {
    // 获取商品分类数据
    ...
    // 获取商品分类数据
    async getCateListByPage(yushu) {
      if(yushu) return this.getCateList()
    ...
    async removeCateById(id) {
      ...
      this.getCateListByPage(this.yushu)
    }
  }
}
</script>
